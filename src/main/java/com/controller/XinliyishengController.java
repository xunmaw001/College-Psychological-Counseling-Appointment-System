...
public class XinliyishengController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		XinliyishengEntity user = xinliyishengService.selectOne(new EntityWrapper<XinliyishengEntity>().eq("xinliyishengzhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"xinliyisheng",  "心理医生" );
    ...
    public R register(@RequestBody XinliyishengEntity xinliyisheng){
    	...
    	XinliyishengEntity user = xinliyishengService.selectOne(new EntityWrapper<XinliyishengEntity>().eq("xinliyishengzhanghao", xinliyisheng.getXinliyishengzhanghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        XinliyishengEntity user = xinliyishengService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        user.setMima("123456");
        xinliyishengService.updateById(user);
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XinliyishengEntity xinliyisheng, HttpServletRequest request){
        EntityWrapper<XinliyishengEntity> ew = new EntityWrapper<XinliyishengEntity>();
    	PageUtils page = xinliyishengService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xinliyisheng), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<XinliyishengEntity> wrapper = new EntityWrapper<XinliyishengEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = xinliyishengService.selectCount(wrapper);

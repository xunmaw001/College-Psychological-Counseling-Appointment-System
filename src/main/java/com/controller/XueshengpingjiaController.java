...
public class XueshengpingjiaController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengpingjiaEntity xueshengpingjia, 
		...
		if(tableName.equals("xinliyisheng")) {
			xueshengpingjia.setXinliyishengzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("xuesheng")) {
			xueshengpingjia.setXueshenghao((String)request.getSession().getAttribute("username"));
		}

...
<body>
  <div id="app">
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in xinliyishengxinxiList" v-bind:key="index" @click="jump('../xinliyishengxinxi/detail.jsp?id='+item.id)">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`xinliyishengxinxi/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.xinliyishengxinxiList = res.data.list;
      });
    });
  </script>
</body>

		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                    if(!data.xinliyishengzhanghao){
                        layer.msg('心理医生账号不能为空', {
							time: 2000,
							icon: 5
						});
                        return false
                        ...
                        return false
                                                                                                                                                                                    					                    ...
                                                                                                                                                                                    					                    if(!data.xinliyishengxingming){
                        layer.msg('心理医生姓名不能为空', {
							time: 2000,
							icon: 5
						});
                        return false
					...
					// 提交数据
					http.requestJson('xinliyisheng' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {

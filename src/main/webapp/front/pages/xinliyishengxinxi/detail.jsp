				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('xinliyishengxinxi','预约咨询')" @click="onAcrossTap('yuyuezixun')" type="button" class="layui-btn">
								预约咨询
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`xinliyishengxinxi`);
